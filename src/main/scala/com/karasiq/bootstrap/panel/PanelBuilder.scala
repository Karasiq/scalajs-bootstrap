...
case class PanelBuilder(style: PanelStyle = PanelStyle.default, header: Option[Modifier] = None, footer: Option[Modifier] = None) {
  ...
  def build(content: Modifier, panelId: String = Bootstrap.newId): Tag = {
